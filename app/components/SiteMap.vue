...
.site-map {
	...
	nav {
		...
		a {
			...
			font-weight: 500;
			padding: 10px 0;
			border-bottom: 1px solid rgba(var(--goldRGB), 0.25);
			@include mixins.r('font-size', 14, 16);			
		}
	}
